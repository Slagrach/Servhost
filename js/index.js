...
} //Добавление класса активному пункту меню при скролле ==================================================================
  ...
  for (var i = 0; i < collection.length; i++) {
    ...
    if (el.offsetTop - header.clientHeight <= scrollDistance) {
      for (var j = 0; j < links.length; j++) {
        ...
        if ($el.classList.contains('_link_active')) {
          $el.classList.remove('_link_active');
        }
      }

      $item[i].querySelector('a').classList.add('_link_active');
      links[i].classList.add('_link_active');
    }
  }
});
/*!
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && "object" !== 'undefined' ? module.exports = factory(__webpack_require__(492)) : typeof define === 'function' && __webpack_require__.amdO ? define(['@popperjs/core'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.bootstrap = factory(global.Popper));
  ...
  var Modal = /*#__PURE__*/function (_BaseComponent6) {
    ...
    _createClass(Modal, [{
      ...
      value: function _showElement(relatedTarget) {
        var _this26 = this; // try to append dynamic modal
      ...
      value: function _initializeTargetsAndObservables() {
        ...
        try {
          for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
            var anchor = _step26.value; // ensure that the anchor has an id and is not disabled
      ...
      value: function _activateParents(target) {
        ...
        try {
          for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
            var listGroup = _step27.value; // Set triggered links parents as active
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && "object" !== 'undefined' ? module.exports = factory() : typeof define === 'function' && __webpack_require__.amdO ? define(factory) : (global = global || self, global.Headroom = factory());
})(void 0, function () {
  'use strict';
...
var links = document.querySelectorAll('._nav a'); //Добавление класса шапке при скролле ========================================================================
// let lastScroll = 0;
// const defaultOffset = 122;
...
//Up button ============================================================================================================
// document.addEventListener('DOMContentLoaded', function () {
// 	let btn = document.querySelector('.up__btn');
// 	window.addEventListener('scroll', function () {
...
// 	});
// });
//Добавление кдасса когда элемент в поле видимости =====================================================================
// Получаем нужный элемент
// var element = document.querySelector('.footer');
// var scrollUp = document.querySelector('.up__btn');
...
// 		scrollUp.classList.add('_visible');
// 		element.classList.add('_visible');
// 		// console.log('Вы видите элемент :)');
// 	} else {
// 		// Если элемент не видно, то запускаем этот код
// 		scrollUp.classList.remove('_visible');
...
// Visible(element);
//Полифил для sticky в IE11 ============================================================================================
//Указываем элемент который должен прилипнуть
// stickybits('#sticky', {useStickyClasses: true});

var idHeader = document.querySelector("#header"); // navbar is the header tag id name
// var headroom = new Headroom(idHeader, {
// 	offset: 205,
...
// 	offset: 205,
// 	tolerance: {down: 10, up: 20},
// 	classes: {initial: "animated", pinned: "swingInX", unpinned: "swingOutX"}
// });
// headroom.init();
// navbar is the header tag id name
// var headroom = new Headroom(header, {
// 	offset: 205,
// 	tolerance: {down: 10, up: 20},
// 	classes: {initial: "animated", pinned: "flipInX", unpinned: "flipOutX"}
// });
// headroom.init();
// navbar is the header tag id name
...
headroom.init(); // document.querySelector('button').addEventListener('click', function () {
